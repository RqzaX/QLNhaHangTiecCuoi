...
namespace UI
{
    partial class FrmBanHang
    {
        ...
        private void InitializeComponent()
        {
            ...
            roundedButton1 = new Guna2Button();
            txtTimMon = new Guna2TextBox();
            panel3 = new Panel();
            btnXoaTatCaMon = new Guna2Button();
            panelGioHang = new Panel();
            btnChonBan = new Guna2Button();
            ...
            label7 = new Label();
            label6 = new Label();
            btnGuiXuongBep = new Guna2Button();
            roundedButton9 = new Guna2Button();
            ...
            // roundedButton1
            // 
            roundedButton1.Animated = true;
            roundedButton1.BorderRadius = 10;
            roundedButton1.DisabledState.BorderColor = Color.DarkGray;
            roundedButton1.DisabledState.CustomBorderColor = Color.DarkGray;
            roundedButton1.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            roundedButton1.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            roundedButton1.FillColor = Color.Black;
            roundedButton1.Font = new Font("Segoe UI Semibold", 10.5F);
            roundedButton1.ForeColor = Color.White;
            roundedButton1.HoverState.FillColor = Color.FromArgb(64, 64, 64);
            roundedButton1.Location = new Point(6, 4);
            roundedButton1.Margin = new Padding(3, 2, 3, 2);
            roundedButton1.Name = "roundedButton1";
            roundedButton1.ShadowDecoration.BorderRadius = 10;
            roundedButton1.ShadowDecoration.Depth = 2;
            roundedButton1.ShadowDecoration.Enabled = true;
            ...
            // txtTimMon
            // 
            txtTimMon.BackColor = Color.Transparent;
            txtTimMon.BorderColor = Color.FromArgb(225, 229, 234);
            txtTimMon.BorderRadius = 10;
            txtTimMon.BorderThickness = 2;
            ...
            txtTimMon.FocusedState.BorderColor = Color.FromArgb(31, 111, 235);
            txtTimMon.Font = new Font("Segoe UI", 10F);
            txtTimMon.ForeColor = Color.Black;
            txtTimMon.HoverState.BorderColor = Color.FromArgb(31, 111, 235);
            ...
            txtTimMon.ShadowDecoration.BorderRadius = 10;
            txtTimMon.ShadowDecoration.Depth = 2;
            txtTimMon.ShadowDecoration.Enabled = true;
            ...
            panel3.Controls.Add(btnGuiXuongBep);
            ...
            // btnXoaTatCaMon
            // 
            btnXoaTatCaMon.Animated = true;
            btnXoaTatCaMon.BorderRadius = 10;
            btnXoaTatCaMon.DisabledState.BorderColor = Color.DarkGray;
            btnXoaTatCaMon.DisabledState.CustomBorderColor = Color.DarkGray;
            btnXoaTatCaMon.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            btnXoaTatCaMon.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnXoaTatCaMon.FillColor = Color.IndianRed;
            ...
            btnXoaTatCaMon.ShadowDecoration.BorderRadius = 10;
            btnXoaTatCaMon.ShadowDecoration.Depth = 2;
            btnXoaTatCaMon.ShadowDecoration.Enabled = true;
            ...
            // btnChonBan
            // 
            btnChonBan.Animated = true;
            btnChonBan.BorderRadius = 15;
            btnChonBan.DisabledState.BorderColor = Color.DarkGray;
            btnChonBan.DisabledState.CustomBorderColor = Color.DarkGray;
            btnChonBan.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            btnChonBan.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnChonBan.FillColor = Color.DeepSkyBlue;
            btnChonBan.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold, GraphicsUnit.Point, 0);
            ...
            btnChonBan.ShadowDecoration.BorderRadius = 15;
            btnChonBan.ShadowDecoration.Depth = 3;
            btnChonBan.ShadowDecoration.Enabled = true;
            btnChonBan.Size = new Size(313, 50);
            btnChonBan.TabIndex = 8;
            btnChonBan.Text = "Chọn bàn để bắt đầu";
            btnChonBan.AutoSize = false;
            ...
            // btnGuiXuongBep
            // 
            btnGuiXuongBep.Animated = true;
            btnGuiXuongBep.BorderRadius = 10;
            btnGuiXuongBep.DisabledState.BorderColor = Color.DarkGray;
            btnGuiXuongBep.DisabledState.CustomBorderColor = Color.DarkGray;
            btnGuiXuongBep.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            btnGuiXuongBep.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnGuiXuongBep.FillColor = Color.Black;
            btnGuiXuongBep.Font = new Font("Segoe UI Semibold", 10.5F);
            btnGuiXuongBep.ForeColor = Color.White;
            btnGuiXuongBep.Location = new Point(12, 520);
            btnGuiXuongBep.Margin = new Padding(3, 2, 3, 2);
            btnGuiXuongBep.Name = "btnGuiXuongBep";
            btnGuiXuongBep.ShadowDecoration.BorderRadius = 10;
            btnGuiXuongBep.ShadowDecoration.Depth = 3;
            btnGuiXuongBep.ShadowDecoration.Enabled = true;
            btnGuiXuongBep.Size = new Size(342, 30);
            btnGuiXuongBep.TabIndex = 18;
            btnGuiXuongBep.Text = "Gửi xuống bếp";
            // 
            // roundedButton9
            // 
            roundedButton9.Animated = true;
            roundedButton9.BorderColor = Color.FromArgb(225, 229, 234);
            roundedButton9.BorderRadius = 10;
            roundedButton9.BorderThickness = 2;
            roundedButton9.DisabledState.BorderColor = Color.DarkGray;
            roundedButton9.DisabledState.CustomBorderColor = Color.DarkGray;
            roundedButton9.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            roundedButton9.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            roundedButton9.FillColor = Color.White;
            ...
            roundedButton9.ShadowDecoration.BorderRadius = 10;
            roundedButton9.ShadowDecoration.Depth = 2;
            roundedButton9.ShadowDecoration.Enabled = true;
        ...
        private Guna2TextBox txtTimMon;
        private Panel panelNhomMon;
        private Panel panel3;
        private Panel panelDanhSachMon;
        private Label label4;
        private Guna2Button btnGuiXuongBep;
        private Guna2Button roundedButton9;
        ...
        private Guna2Button btnChonBan;
        private Guna2Button roundedButton1;
        private Panel panelGioHang;
        private Guna2Button btnXoaTatCaMon;
    }
}